...
**Fused:** library (soft=0.000, margin=0.001, scale=0.0109)
...
**Fused:** passenger (soft=0.000, margin=3.006, scale=0.0109)
...
**Fused:** passenger (soft=0.000, margin=2.866, scale=0.0109)
...
**Fused:** golden gate (soft=0.000, margin=2.784, scale=0.0109)
...
**Fused:** mozzarella (soft=0.000, margin=2.627, scale=0.0109)
